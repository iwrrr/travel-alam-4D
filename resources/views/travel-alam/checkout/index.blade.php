            ...
            <div class="card">
              <div class="card-body">
                <table class="table my-4">
                  ...
                  <tbody>
                    <tr>
                      <td colspan="2"><img src="{{ asset('travel-alam/assets/img/Sleepingbag.jpg') }}" alt="sleepingbagsm" height="60" width="60"> Sleeping Bag Uk. S dan M</td>
                      <td><p class="my-3 prim-color">Rp. 12.000,-</p></td>
                      <td><p class="my-3 prim-color">1</p></td>
                      <td><p class="my-3 prim-color">Rp. 12.000,-</p></td>
                    </tr>
                    <tr>
                      <td colspan="2"><img src="{{ asset('travel-alam/assets/img/tenda.png') }}" alt="tenda" height="60" width="60"> Tenda Kapasitas 2-3 Orang</td>
                      <td><p class="my-3 prim-color">Rp. 35.000,-</p></td>
                      <td><p class="my-3 prim-color">1</p></td>
                      <td><p class="my-3 prim-color">Rp. 35.000,-</p></td>
                    </tr>
                    <tr>
                      <td colspan="2"><img src="{{ asset('travel-alam/assets/img/tenda.png') }}" alt="tenda" height="60" width="60"> Tenda Kapasitas 4-5 Orang</td>
                      <td><p class="my-3 prim-color">Rp. 45.000,-</p></td>
                      <td><p class="my-3 prim-color">1</p></td>
                      <td><p class="my-3 prim-color">Rp. 45.000,-</p></td>
                    </tr>
                    <tr>
                      <td colspan="2"><img src="{{ asset('travel-alam/assets/img/komporr.jpg') }}" alt="kompor" height="60" width="60"> Kompor Portable + Gas</td>
                      <td><p class="my-3 prim-color">Rp. 30.000,-</p></td>
                      <td><p class="my-3 prim-color">1</p></td>
                      <td><p class="my-3 prim-color">Rp. 30.000,-</p></td>
                    </tr>
                    <tr>
                      <td colspan="2"><img src="{{ asset('travel-alam/assets/img/tas.jpg') }}" alt="kompor" height="60" width="60"> Tas Carrier 60L</td>
                      <td><p class="my-3 prim-color">Rp. 35.000,-</p></td>
                      <td><p class="my-3 prim-color">1</p></td>
                      <td><p class="my-3 prim-color">Rp. 35.000,-</p></td>
                    </tr>
                  ...
                  <tfoot>
                      ...
                      <td><p class="my-3 prim-color">Rp. 157.000,-</p></td>
                  </tfoot>
                </table>
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="row my-4">
                <div class="col-4">
                  ...
                  <input type="date" class="form-control dropdown-toggle w-100">
                </div>
                <div class="col-4">
                  <h6>Durasi Peminjaman (Hari)</h6>
                  <input type="number" class="form-control dropdown-toggle w-50" min="1" max="7">
                </div>
              </div>
