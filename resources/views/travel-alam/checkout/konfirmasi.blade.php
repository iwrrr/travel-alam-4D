      ...
      <div class="row mb-4">
        <div class="col-md">
          <header class="keranjang-header">
            <h3><img src="{{ asset('travel-alam/assets/img/Icon material-shopping-cart-1.png') }}" height="25" alt=""> Konfirmasi Pembayaran </h3>
        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
              ...
              <a href="#" class="btn btn-success my-4 w-100 btn-theme">Bayar Sekarang</a>
            </div>
          </div>
        </div>
